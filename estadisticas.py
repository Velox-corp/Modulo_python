...
cuerpo = """ <!DOCTYPE html>
    ...
    <body class='container-fluid'>
        <main>
            <article>
                Aquí se pretende mostrar las frecuencias de los elementos a considerar dle entrenamiento del test para poder entender mejor que caracteristicas tienen mayor impacto en el algoritmo. 
            </article>
